...
<body>
    ...
    $plageshoraires =\App\plageshoraires::orderBy('date', 'asc')->get();
?>
    <table class="table">
  ...
  <thead>
    ...
    @foreach ($plageshoraires as $m)
    <th scope="col"><a class="btn btn-success" href="{{route('AffichePointage',['id'=>$m->id])}}" role="button"> Pointage</a>
