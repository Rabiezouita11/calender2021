        ...
        @foreach ($users as $prof)
          <tr>
              ...
              <td>
                ...
                <a class="btn btn-success" href="{{route('modifierens',['id'=>$prof->id])}}" role="button">Modifier</a>
                <a class="btn btn-danger" href="{{route('supprimerens',['id'=>$prof->id])}}" role="button">Supprimer</a>
...
@endforeach
          ...
          <a class="btn btn-primary" href="{{route('Ajouterens')}}" role="button">Ajouter </a>
