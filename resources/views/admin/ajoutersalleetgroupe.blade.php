...
<div class="col-sm-6"><br><br>
        <h1 ><em><small>  
Les salles et les groupes </small></em></h1>
      </div>  </br>  
      @if (session('success'))
        ...
        @foreach ($emplois as $e)
          <tr>
              ...
              <td>
                ...
                <a class="btn btn-success" href="{{route('supprimerSG',['id'=>$e->id])}}" role="button">Supprimer</a>
...
@endforeach
          ...
          <a class="btn btn-primary" href="{{route('ajoutergroupe')}}" role="button">Ajouter </a>
