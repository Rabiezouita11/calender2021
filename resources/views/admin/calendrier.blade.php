...
<div class="col-sm-6">
<h2 style="  font-style: italic;">Calendrier </h2>      </div>  </br>  
      @if (session('success'))
       ...
       <table class="table table-bordered">
        ...
        @foreach ($calendriers as $c)
          <tr>
              ...
              <td>{{$c->dateD}} </td>
              <td>{{$c->jour}}</td>
              <td>{{$c->hd}}</td><td>{{$c->hf}}</td>
              <td>                <a class="btn btn-danger" href="" role="button">Supprimer</a>
              </td>
...
<a class="btn btn-primary" href="{{route('ajouterCal')}}" role="button">ajouter</a>  
