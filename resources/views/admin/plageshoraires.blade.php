...
<div class="col-sm-6">
        <h1><small><em> Les plages horaires</em></small></h1>
      </div>  </br>  
      @if (session('success'))
       ...
       <table class="table table-striped table-dark">
        <thead>
          ...
          <tr>
            ...
            <th scope="col">Nombre des enseignants </th>
        ...
        <tbody>
        @foreach ($plageshoraires as $temps)
          <tr>
              <td> {{$temps->id}} </td>
              <td> {{$temps->jour}} </td>
              ...
              <td>
                ...
                <a class="btn btn-success" href= "{{route('modifierTemps',['id'=>$temps->id])}}"role="button">Modifier</a>
                <a class="btn btn-danger" href="{{route('supprimerTemps',['id'=>$temps->id])}}" role="button">Supprimer</a>
...
@endforeach
          ...
          <a class="btn btn-primary" href="{{route('Ajouterdate')}}" role="button">Ajouter </a>
