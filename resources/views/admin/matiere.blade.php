...
<div class="col-sm-6">
        <h1><small><em>Liste des Matiéres</em></small></h1>
      </div>  </br>  
      @if (session('success'))
        ...
        @foreach ($matieres as $M)
          <tr>
              ...
              <td>
                ...
                <a class="btn btn-success" href="{{route('modifierMatiere',['id'=>$M->id])}}" role="button">Modifier</a>
                <a class="btn btn-danger" href="{{route('supprimerMatiere',['id'=>$M->id])}}" role="button">Supprimer</a>
...
@endforeach
          ...
          <a class="btn btn-primary" href="{{route('ajoutermatiere')}}" role="button">Ajouter</a>
            </table>     
       </div>         
