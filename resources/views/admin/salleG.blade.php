...
<div class="col-sm-6">
        <h1><small><em>Liste des Salles</em></small></h1>
      </div>  </br>  
      @if (session('success'))
...
<th scope="com">Action</th>

          </tr>

        </thead>
        <tbody>
        @foreach ($salle_g_s as $salle)
          <tr>
              <td> {{$salle->id}} </td>
              ...
              <td>
                ...
                <a class="btn btn-success" href="{{route('modifierSalle',['id'=>$salle->id])}}" role="button">Modifier</a>
                <a class="btn btn-danger" href="{{route('supprimerSalle',['id'=>$salle->id])}}" role="button">Supprimer</a>
...
@endforeach
          ...
          <a class="btn btn-primary" href="{{route('Ajoutersalle')}}" role="button">Ajouter </a>
