...
<div class="col-sm-6">
        <h1 ><small><em>Les Groupes</em></small></h1>
      </div>  </br>  
      @if (session('success'))
       ...
       <table class="table table-striped table-dark">
        ...
        @foreach ($groupes as $groupe)
          <tr>
              ...
              <td> {{$groupe->section}}{{$groupe->niveaux}}{{$groupe->nom}}  </td>
              ...
              <td>
                ...
                <a class="btn btn-success" href="{{route('modifierGroupe',['id'=>$groupe->id])}}" role="button">Modifier</a>
                <a class="btn btn-danger" href="{{route('DeleteGroupe',['id'=>$groupe->id])}}" role="button">Supprimer</a>
...
@endforeach
          ...
          <a class="btn btn-primary" href="{{route('ShowAddSection')}}" role="button">Ajouter </a>
